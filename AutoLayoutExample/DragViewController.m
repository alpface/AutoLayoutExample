...
- (void)panGestureRecognizerActionOnButton:(UIPanGestureRecognizer *)pan {
    ...
    switch (pan.state) {
        ...
        case UIGestureRecognizerStateEnded: {
            // 手势结束时恢复布局
            [UIView animateWithDuration:0.5 delay:0.0 usingSpringWithDamping:0.3 initialSpringVelocity:5.0 options:UIViewAnimationOptionBeginFromCurrentState | UIViewAnimationOptionCurveEaseInOut animations:^{
